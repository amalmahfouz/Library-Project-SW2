...
<div class="menu" id="menu">
     ...
     <?php 
     echo "<div class='search'>search on " .$search."</div>";
      echo "<br> <br>";?>
    ...
    <?php
        ...
        $sql = "SELECT * FROM books WHERE title LIKE '%$search%' OR descripition LIKE '%$search%' OR author LIKE '%$search%'and active='Yes'";
